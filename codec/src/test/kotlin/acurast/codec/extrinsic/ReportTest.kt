...
class ReportTest {
    ...
    fun encodeCall() {
        ...
        val call = ReportCall(callIndex, jobId)
        Assert.assertEquals(call.toU8a().toHex(), "2b048eaf04151687736326c9fea17e25fc5287613693c912909cb226aa4794f26a48d4697066733a2f2f516d5378377a44706b76627975674c33553339467454617357784d6d6b6647363773783977614752564837415145")
    }
